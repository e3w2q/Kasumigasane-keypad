...
| 幅15mmのマスキングテープ | 1個以上 | 好きな柄のもの |  |  |

## オプション

| 名前                                                      | 数                         | 備考                                                         | 調達先の例                                                   | 参考価格       |
| --------------------------------------------------------- | -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | -------------- |
| 2U PCBマウントスタビライザー | 1～3個 | 2Uキーを使いたい場合 | https://talpkeyboard.net/?category_id=5f884b9b3313d216eb50558a | 1個600円など |
| ロータリーエンコーダ | 1個 | ロータリーエンコーダを実装する場合<br />バックライトとの併用は不可 | https://talpkeyboard.net/items/5f3f1a597df28129f2fd4b0f | 200円 |
| SK6812MINI-E | 16個 | バックライトを実装する場合<br />ロータリーエンコーダとの併用は不可 | https://akizukidenshi.com/catalog/g/gI-15478/                | 5個で110円 |
| カプトンテープ | 40mm長程度×2 | 柔らかいデスクマットの上や膝の上や金属のテーブルの上で使用する場合 | https://akizukidenshi.com/catalog/g/gT-09379/ | 250円 |
