...
- [霞襲 ビルドガイド](#霞襲-ビルドガイド)
    ...
    - [ビルドガイド](#ビルドガイド)
        ...
        - [オプション:バックライト用LEDの取り付け](#オプションバックライト用ledの取り付け)
...
![led_position](C:/tool/GitHub/Kasumigasane-keypad/doc/led_position.jpg)

Backlightと書かれたジャンパをハンダで導通させます。

![led_jamper](C:/tool/GitHub/Kasumigasane-keypad/doc/led_jamper.jpg)
...
外周部分は幅が大きいため、ガンダムマーカーやポスカではあまりきれいに塗れないと思いますので、マスキングテープがおすすめです。
