...
お好みで、ガンダムマーカーやポスカで塗ったり、好きな柄のマスキングテープで囲んでみてもよいです。
...
### オプション:バックライト用LEDの取り付け

基板を裏返し、Pro Microを外し、各スイッチにタブ付きのRGBLEDをはんだ付けします。基板の裏側から見たときに、LEDは裏側が見えるようにし、LEDのタブの欠けがシルクのL字と一致するように付けます。
